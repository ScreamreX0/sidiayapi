...
//        if (ticket.getExecutor() == null) throw new DataIntegrityViolationException("Ticket has no executor");
...
//        if (!ticket.getExecutor().getId().equals(userId) && !ticket.getAuthor().getId().equals(userId)) throw new WrongCredentialsException("Current user is neither the author nor the executor");
...
//                return false;
//            } else if (ticket.getExecutor().getId().equals(userId)) {
//                return true;
//            } else {
